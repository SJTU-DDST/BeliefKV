...
Start with the [documentation index](docs/README_zh.md). The authoritative
current design is
[docs/beliefkv_design_2026-07-14_zh.md](docs/beliefkv_design_2026-07-14_zh.md);
the code and validation status is
[docs/architecture_status_zh.md](docs/architecture_status_zh.md); and the only
active execution order is
[docs/implementation_plan.md](docs/implementation_plan.md). Experiment reports
are immutable evidence rather than current architecture documents. Superseded
plans and the former append-only status/design pages are retained under
[docs/archive/](docs/archive/README_zh.md).
